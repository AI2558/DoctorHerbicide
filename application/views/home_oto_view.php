...
<div class="container">
	...
	<div class="jumbotron text-center">
        ...
        <tbody>
        	<?php for ($i=0; $i<sizeof($anti); $i++) { ?>
            <tr>
            	<!-- <td><?= $r['group'] ?></td> -->
            	<td><img onerror="this.src='http://localhost/weed/assets/images/pill/no_image.png'" class="img-responsive img-rounded center-block img-zoom" src='<?= base_url("assets/images/pill/" . $anti[$i]) . ".png" ?>' /></td>
            	<td style="vertical-align:middle"><?= $anti[$i] ?></td>
            </tr>
            <?php } ?>
       </tbody>
       </table>
	...
	<?php } ?>
	<div class="jumbotron text-center">
		<form id="weed_form" name="weed_form" action="<?= base_url('home_oto/weed') ?>" method="post" role="form">
